 ...
 */
export class FriendsDataSource extends DataSource<EventFriend> {
   ...
   */
  connect(): Observable<EventFriend[]> {
   ...
   */
  private getPagedData(data: EventFriend[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: EventFriend[]) {
